  ...
  data() {
    return {
      ...
      perguntaList: [
        {
          id: 0,
          descricao: "Todas as perguntas",
          opcoes: [
            { id: 1, descricao: "Excelente", valor: 1 },
            { id: 2, descricao: "Bom", valor: 2 },
        ...
        {
          id: 1,
          descricao: "O que motiva você a comprar com a Info Store?",
          opcoes: [
            { id: 1, descricao: "Excelente", valor: 6 },
            { id: 2, descricao: "Bom", valor: 7 },
        ...
        {
          id: 2,
          descricao: "O quão satisfeito você ficou com nosso atendimento?",
          opcoes: [
            { id: 1, descricao: "Excelente", valor: 11 },
            { id: 2, descricao: "Bom", valor: 12 },
        ...
        {
          id: 3,
          descricao: "O quanto conseguimos atender todas as suas expectativas?",
          opcoes: [
            { id: 1, descricao: "Excelente", valor: 11 },
            { id: 2, descricao: "Bom", valor: 12 },
            { id: 3, descricao: "Neutro", valor: 13 },
        ...
        },
        {
          id: 4,
          descricao:
            "Qual a probabilidade de você fazer novas compras na Info Store?",
          opcoes: [
            { id: 1, descricao: "Excelente", valor: 11 },
            { id: 2, descricao: "Bom", valor: 12 },
            { id: 3, descricao: "Neutro", valor: 13 },
        ...
        },
        {
          id: 5,
          descricao:
            "O quanto você recomendaria a empresa Info Store para seus amigos e/ou parentes?",
          opcoes: [
            { id: 1, descricao: "Excelente", valor: 11 },
            { id: 2, descricao: "Bom", valor: 12 },
            { id: 3, descricao: "Neutro", valor: 13 },
